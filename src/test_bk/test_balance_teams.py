...
def setup_players(client, db_session: Session):
    usernames = [
        ("Alice", {"tiro": 80, "ritmo": 90, "fisico": 85, "defensa": 70, "magia": 75}),
        ("Bob", {"tiro": 78, "ritmo": 88, "fisico": 82, "defensa": 72, "magia": 70}),
        ("Charlie", {"tiro": 50, "ritmo": 60, "fisico": 55, "defensa": 65, "magia": 40}),
        ("Diana", {"tiro": 45, "ritmo": 55, "fisico": 50, "defensa": 60, "magia": 35}),
        ("Eddie", {"tiro": 88, "ritmo": 85, "fisico": 90, "defensa": 80, "magia": 95}),
        ("Fiona", {"tiro": 83, "ritmo": 82, "fisico": 88, "defensa": 78, "magia": 90}),
        ("Leo", {"tiro": 75, "ritmo": 70, "fisico": 72, "defensa": 65, "magia": 68}),
        ("Max", {"tiro": 78, "ritmo": 74, "fisico": 69, "defensa": 70, "magia": 72}),
        ("Nia", {"tiro": 73, "ritmo": 68, "fisico": 75, "defensa": 66, "magia": 65}),
        ("Ola", {"tiro": 80, "ritmo": 72, "fisico": 70, "defensa": 68, "magia": 70}),
        ("Paz", {"tiro": 77, "ritmo": 69, "fisico": 74, "defensa": 67, "magia": 69}),
        ("Rex", {"tiro": 70, "ritmo": 75, "fisico": 68, "defensa": 69, "magia": 66}),
        ("Sol", {"tiro": 74, "ritmo": 73, "fisico": 71, "defensa": 64, "magia": 67}),
        ("Tia", {"tiro": 76, "ritmo": 70, "fisico": 73, "defensa": 65, "magia": 68}),
        ("Ula", {"tiro": 72, "ritmo": 71, "fisico": 69, "defensa": 66, "magia": 65}),
        ("Val", {"tiro": 79, "ritmo": 74, "fisico": 70, "defensa": 67, "magia": 70}),
        ("Wes", {"tiro": 71, "ritmo": 72, "fisico": 68, "defensa": 65, "magia": 66}),
        ("Yas", {"tiro": 75, "ritmo": 73, "fisico": 72, "defensa": 68, "magia": 69}),
        ("Zoe", {"tiro": 73, "ritmo": 70, "fisico": 71, "defensa": 66, "magia": 67}),
    ]
