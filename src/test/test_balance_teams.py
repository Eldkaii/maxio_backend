...
def setup_players(client, db_session: Session):
    usernames = [
        ("Alice", {"punteria": 80, "velocidad": 90, "dribbling": 85, "defensa": 70, "magia": 75}),
        ("Bob", {"punteria": 78, "velocidad": 88, "dribbling": 82, "defensa": 72, "magia": 70}),
        ("Charlie", {"punteria": 50, "velocidad": 60, "dribbling": 55, "defensa": 65, "magia": 40}),
        ("Diana", {"punteria": 45, "velocidad": 55, "dribbling": 50, "defensa": 60, "magia": 35}),
        ("Eddie", {"punteria": 88, "velocidad": 85, "dribbling": 90, "defensa": 80, "magia": 95}),
        ("Fiona", {"punteria": 83, "velocidad": 82, "dribbling": 88, "defensa": 78, "magia": 90}),
        ("Leo", {"punteria": 75, "velocidad": 70, "dribbling": 72, "defensa": 65, "magia": 68}),
        ("Max", {"punteria": 78, "velocidad": 74, "dribbling": 69, "defensa": 70, "magia": 72}),
        ("Nia", {"punteria": 73, "velocidad": 68, "dribbling": 75, "defensa": 66, "magia": 65}),
        ("Ola", {"punteria": 80, "velocidad": 72, "dribbling": 70, "defensa": 68, "magia": 70}),
        ("Paz", {"punteria": 77, "velocidad": 69, "dribbling": 74, "defensa": 67, "magia": 69}),
        ("Rex", {"punteria": 70, "velocidad": 75, "dribbling": 68, "defensa": 69, "magia": 66}),
        ("Sol", {"punteria": 74, "velocidad": 73, "dribbling": 71, "defensa": 64, "magia": 67}),
        ("Tia", {"punteria": 76, "velocidad": 70, "dribbling": 73, "defensa": 65, "magia": 68}),
        ("Ula", {"punteria": 72, "velocidad": 71, "dribbling": 69, "defensa": 66, "magia": 65}),
        ("Val", {"punteria": 79, "velocidad": 74, "dribbling": 70, "defensa": 67, "magia": 70}),
        ("Wes", {"punteria": 71, "velocidad": 72, "dribbling": 68, "defensa": 65, "magia": 66}),
        ("Yas", {"punteria": 75, "velocidad": 73, "dribbling": 72, "defensa": 68, "magia": 69}),
        ("Zoe", {"punteria": 73, "velocidad": 70, "dribbling": 71, "defensa": 66, "magia": 67}),
    ]
